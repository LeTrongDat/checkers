...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgRejectGame({ value }: msgRejectGameParams): EncodeObject {
			try {
				return { typeUrl: "/letrongdat.checkers.checkers.MsgRejectGame", value: MsgRejectGame.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgPlayMove({ value }: msgPlayMoveParams): EncodeObject {
			try {
				return { typeUrl: "/letrongdat.checkers.checkers.MsgPlayMove", value: MsgPlayMove.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreateGame({ value }: msgCreateGameParams): EncodeObject {
			try {
				return { typeUrl: "/letrongdat.checkers.checkers.MsgCreateGame", value: MsgCreateGame.fromPartial( value ) }  
			} catch (e: any) {
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			LetrongdatCheckersCheckers: new SDKModule(test)
		},
		registry: msgTypes
  }
}
