...
var (
	...
	ErrInvalidDeadline         = sdkerrors.Register(ModuleName, 1109, "deadline can not be parsed: %s")
	...
	ErrCannotPayWinnings       = sdkerrors.Register(ModuleName, 1116, "cannot pay winning to winner: %s")
